...
Cho mảng $a$ gồm $n$ phần tử. Tính $\max(a) \cdot \min(a)$ sau khi xoá đi phần tử $a_{n}$.
...
Chúng ta chỉ cần đếm số lượng phần tử khác nhau để kiểm tra xem phần tử đó có tồn tại không, rồi kiểm tra xem số lượng phần tử của nó có bằng $m$ không, nếu có thì in ra $(i - 1) \cdot 5$ (vì bạn Nam chỉ cần đi $(i-1)$ lần).
